system("nard2 new $(dirname $(whereis nard2 | awk '{print $2}'))/src/user_functions/heat_NA_t_squared.f90 _convtesting_CNNAD");
...
for i = 1:length(dt_range)
    ...
    savefilename = sprintf("%s/test_CNNAD/results_%i_CN.h5",pwd(), i);
